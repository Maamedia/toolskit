...
<div class="card-deck"><div class="card toolinfo" data-tool="wysiwyg">
    ...
    <h6 class="card-subtitle mb-2 text-muted">
        Tool: <a href="https://maamedia.org/toolskit/wysiwyg.php">Wysiwyg Editor</a>
    </h6>
...
<div class="card-deck"><div class="card toolinfo" data-tool="proofreader">
    <div class="card-body">
      <h4 class="card-title">
                Proofreader
              </h4>
      <h6 class="card-subtitle mb-2 text-muted">
        Tool: <a href="https://maamedia.org/toolskit/proofread.php">Proofreader</a>
      </h6>
      <div class="card-text"></div>
    </div>
    </div><div class="card toolinfo" data-tool="barcodegenerator">
        <div class="card-body">
      <h4 class="card-title">
                Barcode Generator
              </h4>
