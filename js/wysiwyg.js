...
/***/ function(module, exports, __webpack_require__) {
	...
	var Quill = function () {
	  ...
	  function Quill(container) {
	    ...
	    this.root = this.addContainer('mt-editor');
	    ...
	    this.theme.init();
	    this.pasteHTML('<div class=\'mt-editor\' style="white-space: normal;">' + html + '<p><br></p></div>');
	    this.history.clear();
	    if (options.readOnly) {
	      this.disable();
	    }
	    ...
	    this.root.classList.toggle('mt-blank', this.editor.isBlank());
	    this.emitter.on(_emitter2.default.events.TEXT_CHANGE, function (delta) {
	      _this2.root.classList.toggle('mt-blank', _this2.editor.isBlank());
	    });
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Clipboard = function (_Module) {
	  ...
	  function Clipboard(quill, options) {
	    ...
	    _this.container = _this.quill.addContainer('mt-clipboard');
	...
	function computeStyle(node) {
	  ...
	  var DOM_KEY = '__mt-computed-style';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AlignClass = new _parchment2.default.Attributor.Class('align', 'mt-align', config);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BackgroundClass = new _parchment2.default.Attributor.Class('background', 'mt-bg', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ColorClass = new _parchment2.default.Attributor.Class('color', 'mt-color', {
	  scope: _parchment2.default.Scope.INLINE
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DirectionClass = new _parchment2.default.Attributor.Class('direction', 'mt-direction', config);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FontClass = new _parchment2.default.Attributor.Class('font', 'mt-font', config);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SizeClass = new _parchment2.default.Attributor.Class('size', 'mt-size', {
	  scope: _parchment2.default.Scope.INLINE,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var IndentClass = new IdentAttributor('indent', 'mt-indent', {
	  scope: _parchment2.default.Scope.BLOCK,
...
/***/ function(module, exports, __webpack_require__) {
	...
	FormulaBlot.className = 'mt-formula';
...
/***/ function(module, exports, __webpack_require__) {
	...
	SyntaxCodeBlock.className = 'mt-syntax';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Toolbar = function (_Module) {
	  ...
	  function Toolbar(quill, options) {
	    ...
	    _this.container.classList.add('mt-toolbar');
	    _this.controls = [];
	    _this.handlers = {};
	  ...
	  _createClass(Toolbar, [{
	    ...
	    value: function attach(input) {
	      ...
	      var format = [].find.call(input.classList, function (className) {
	        return className.indexOf('mt-') === 0;
	      });
	      if (!format) return;
	      format = format.slice('mt-'.length);
	      ...
	      input.addEventListener(eventName, function (e) {
	        ...
	        if (input.tagName === 'SELECT') {
	          ...
	          if (input.classList.contains('mt-active')) {
	            value = false;
	          } else {
	    ...
	    value: function update(range) {
	      ...
	      this.controls.forEach(function (pair) {
	        ...
	        if (input.tagName === 'SELECT') {
	          ...
	          if (range == null) {
	            input.classList.remove('mt-active');
	          } else if (input.hasAttribute('value')) {
	            // both being null should match (default values)
	            // '1' should match with 1 (headers)
	            var isActive = formats[format] === input.getAttribute('value') || formats[format] != null && formats[format].toString() === input.getAttribute('value') || formats[format] == null && !input.getAttribute('value');
	            input.classList.toggle('mt-active', isActive);
	          } else {
	            input.classList.toggle('mt-active', formats[format] != null);
	          }
	        }
	      });
	    }
	...
	function addControls(container, groups) {
	  ...
	  groups.forEach(function (controls) {
	    ...
	    group.classList.add('mt-formats');
...
/***/ function(module, exports) {
	...
	module.exports = "<svg viewbox=\"0 0 18 18\"> <line class=mt-stroke x1=3 x2=15 y1=9 y2=9></line> <line class=mt-stroke x1=3 x2=13 y1=14 y2=14></line> <line class=mt-stroke x1=3 x2=9 y1=4 y2=4></line> </svg>";

/***/ },
/* 71 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <line class=mt-stroke x1=15 x2=3 y1=9 y2=9></line> <line class=mt-stroke x1=14 x2=4 y1=14 y2=14></line> <line class=mt-stroke x1=12 x2=6 y1=4 y2=4></line> </svg>";

/***/ },
/* 72 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <line class=mt-stroke x1=15 x2=3 y1=9 y2=9></line> <line class=mt-stroke x1=15 x2=5 y1=14 y2=14></line> <line class=mt-stroke x1=15 x2=9 y1=4 y2=4></line> </svg>";

/***/ },
/* 73 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <line class=mt-stroke x1=15 x2=3 y1=9 y2=9></line> <line class=mt-stroke x1=15 x2=3 y1=14 y2=14></line> <line class=mt-stroke x1=15 x2=3 y1=4 y2=4></line> </svg>";

/***/ },
/* 74 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <g class=\"mt-fill mt-color-label\"> <polygon points=\"6 6.868 6 6 5 6 5 7 5.942 7 6 6.868\"></polygon> <rect height=1 width=1 x=4 y=4></rect> <polygon points=\"6.817 5 6 5 6 6 6.38 6 6.817 5\"></polygon> <rect height=1 width=1 x=2 y=6></rect> <rect height=1 width=1 x=3 y=5></rect> <rect height=1 width=1 x=4 y=7></rect> <polygon points=\"4 11.439 4 11 3 11 3 12 3.755 12 4 11.439\"></polygon> <rect height=1 width=1 x=2 y=12></rect> <rect height=1 width=1 x=2 y=9></rect> <rect height=1 width=1 x=2 y=15></rect> <polygon points=\"4.63 10 4 10 4 11 4.192 11 4.63 10\"></polygon> <rect height=1 width=1 x=3 y=8></rect> <path d=M10.832,4.2L11,4.582V4H10.708A1.948,1.948,0,0,1,10.832,4.2Z></path> <path d=M7,4.582L7.168,4.2A1.929,1.929,0,0,1,7.292,4H7V4.582Z></path> <path d=M8,13H7.683l-0.351.8a1.933,1.933,0,0,1-.124.2H8V13Z></path> <rect height=1 width=1 x=12 y=2></rect> <rect height=1 width=1 x=11 y=3></rect> <path d=M9,3H8V3.282A1.985,1.985,0,0,1,9,3Z></path> <rect height=1 width=1 x=2 y=3></rect> <rect height=1 width=1 x=6 y=2></rect> <rect height=1 width=1 x=3 y=2></rect> <rect height=1 width=1 x=5 y=3></rect> <rect height=1 width=1 x=9 y=2></rect> <rect height=1 width=1 x=15 y=14></rect> <polygon points=\"13.447 10.174 13.469 10.225 13.472 10.232 13.808 11 14 11 14 10 13.37 10 13.447 10.174\"></polygon> <rect height=1 width=1 x=13 y=7></rect> <rect height=1 width=1 x=15 y=5></rect> <rect height=1 width=1 x=14 y=6></rect> <rect height=1 width=1 x=15 y=8></rect> <rect height=1 width=1 x=14 y=9></rect> <path d=M3.775,14H3v1H4V14.314A1.97,1.97,0,0,1,3.775,14Z></path> <rect height=1 width=1 x=14 y=3></rect> <polygon points=\"12 6.868 12 6 11.62 6 12 6.868\"></polygon> <rect height=1 width=1 x=15 y=2></rect> <rect height=1 width=1 x=12 y=5></rect> <rect height=1 width=1 x=13 y=4></rect> <polygon points=\"12.933 9 13 9 13 8 12.495 8 12.933 9\"></polygon> <rect height=1 width=1 x=9 y=14></rect> <rect height=1 width=1 x=8 y=15></rect> <path d=M6,14.926V15H7V14.316A1.993,1.993,0,0,1,6,14.926Z></path> <rect height=1 width=1 x=5 y=15></rect> <path d=M10.668,13.8L10.317,13H10v1h0.792A1.947,1.947,0,0,1,10.668,13.8Z></path> <rect height=1 width=1 x=11 y=15></rect> <path d=M14.332,12.2a1.99,1.99,0,0,1,.166.8H15V12H14.245Z></path> <rect height=1 width=1 x=14 y=15></rect> <rect height=1 width=1 x=15 y=11></rect> </g> <polyline class=mt-stroke points=\"5.5 13 9 5 12.5 13\"></polyline> <line class=mt-stroke x1=11.63 x2=6.38 y1=11 y2=11></line> </svg>";

/***/ },
/* 75 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <rect class=\"mt-fill mt-stroke\" height=3 width=3 x=4 y=5></rect> <rect class=\"mt-fill mt-stroke\" height=3 width=3 x=11 y=5></rect> <path class=\"mt-even mt-fill mt-stroke\" d=M7,8c0,4.031-3,5-3,5></path> <path class=\"mt-even mt-fill mt-stroke\" d=M14,8c0,4.031-3,5-3,5></path> </svg>";

/***/ },
/* 76 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <path class=mt-stroke d=M5,4H9.5A2.5,2.5,0,0,1,12,6.5v0A2.5,2.5,0,0,1,9.5,9H5A0,0,0,0,1,5,9V4A0,0,0,0,1,5,4Z></path> <path class=mt-stroke d=M5,9h5.5A2.5,2.5,0,0,1,13,11.5v0A2.5,2.5,0,0,1,10.5,14H5a0,0,0,0,1,0,0V9A0,0,0,0,1,5,9Z></path> </svg>";

/***/ },
/* 77 */
/***/ function(module, exports) {

	module.exports = "<svg class=\"\" viewbox=\"0 0 18 18\"> <line class=mt-stroke x1=5 x2=13 y1=3 y2=3></line> <line class=mt-stroke x1=6 x2=9.35 y1=12 y2=3></line> <line class=mt-stroke x1=11 x2=15 y1=11 y2=15></line> <line class=mt-stroke x1=15 x2=11 y1=11 y2=15></line> <rect class=mt-fill height=1 rx=0.5 ry=0.5 width=7 x=2 y=14></rect> </svg>";

/***/ },
/* 78 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <polyline class=\"mt-even mt-stroke\" points=\"5 7 3 9 5 11\"></polyline> <polyline class=\"mt-even mt-stroke\" points=\"13 7 15 9 13 11\"></polyline> <line class=mt-stroke x1=10 x2=8 y1=5 y2=13></line> </svg>";

/***/ },
/* 79 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <line class=\"mt-color-label mt-stroke mt-transparent\" x1=3 x2=15 y1=15 y2=15></line> <polyline class=mt-stroke points=\"5.5 11 9 3 12.5 11\"></polyline> <line class=mt-stroke x1=11.63 x2=6.38 y1=9 y2=9></line> </svg>";

/***/ },
/* 80 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <polygon class=\"mt-stroke mt-fill\" points=\"3 11 5 9 3 7 3 11\"></polygon> <line class=\"mt-stroke mt-fill\" x1=15 x2=11 y1=4 y2=4></line> <path class=mt-fill d=M11,3a3,3,0,0,0,0,6h1V3H11Z></path> <rect class=mt-fill height=11 width=1 x=11 y=4></rect> <rect class=mt-fill height=11 width=1 x=13 y=4></rect> </svg>";

/***/ },
/* 81 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <polygon class=\"mt-stroke mt-fill\" points=\"15 12 13 10 15 8 15 12\"></polygon> <line class=\"mt-stroke mt-fill\" x1=9 x2=5 y1=4 y2=4></line> <path class=mt-fill d=M5,3A3,3,0,0,0,5,9H6V3H5Z></path> <rect class=mt-fill height=11 width=1 x=5 y=4></rect> <rect class=mt-fill height=11 width=1 x=7 y=4></rect> </svg>";

/***/ },
/* 82 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <path class=mt-fill d=M14,16H4a1,1,0,0,1,0-2H14A1,1,0,0,1,14,16Z /> <path class=mt-fill d=M14,4H4A1,1,0,0,1,4,2H14A1,1,0,0,1,14,4Z /> <rect class=mt-fill x=3 y=6 width=12 height=6 rx=1 ry=1 /> </svg>";

/***/ },
/* 83 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <path class=mt-fill d=M13,16H5a1,1,0,0,1,0-2h8A1,1,0,0,1,13,16Z /> <path class=mt-fill d=M13,4H5A1,1,0,0,1,5,2h8A1,1,0,0,1,13,4Z /> <rect class=mt-fill x=2 y=6 width=14 height=6 rx=1 ry=1 /> </svg>";

/***/ },
/* 84 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <path class=mt-fill d=M15,8H13a1,1,0,0,1,0-2h2A1,1,0,0,1,15,8Z /> <path class=mt-fill d=M15,12H13a1,1,0,0,1,0-2h2A1,1,0,0,1,15,12Z /> <path class=mt-fill d=M15,16H5a1,1,0,0,1,0-2H15A1,1,0,0,1,15,16Z /> <path class=mt-fill d=M15,4H5A1,1,0,0,1,5,2H15A1,1,0,0,1,15,4Z /> <rect class=mt-fill x=2 y=6 width=8 height=6 rx=1 ry=1 /> </svg>";

/***/ },
/* 85 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <path class=mt-fill d=M5,8H3A1,1,0,0,1,3,6H5A1,1,0,0,1,5,8Z /> <path class=mt-fill d=M5,12H3a1,1,0,0,1,0-2H5A1,1,0,0,1,5,12Z /> <path class=mt-fill d=M13,16H3a1,1,0,0,1,0-2H13A1,1,0,0,1,13,16Z /> <path class=mt-fill d=M13,4H3A1,1,0,0,1,3,2H13A1,1,0,0,1,13,4Z /> <rect class=mt-fill x=8 y=6 width=8 height=6 rx=1 ry=1 transform=\"translate(24 18) rotate(-180)\"/> </svg>";

/***/ },
/* 86 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <path class=mt-fill d=M11.759,2.482a2.561,2.561,0,0,0-3.53.607A7.656,7.656,0,0,0,6.8,6.2C6.109,9.188,5.275,14.677,4.15,14.927a1.545,1.545,0,0,0-1.3-.933A0.922,0.922,0,0,0,2,15.036S1.954,16,4.119,16s3.091-2.691,3.7-5.553c0.177-.826.36-1.726,0.554-2.6L8.775,6.2c0.381-1.421.807-2.521,1.306-2.676a1.014,1.014,0,0,0,1.02.56A0.966,0.966,0,0,0,11.759,2.482Z></path> <rect class=mt-fill height=1.6 rx=0.8 ry=0.8 width=5 x=5.15 y=6.2></rect> <path class=mt-fill d=M13.663,12.027a1.662,1.662,0,0,1,.266-0.276q0.193,0.069.456,0.138a2.1,2.1,0,0,0,.535.069,1.075,1.075,0,0,0,.767-0.3,1.044,1.044,0,0,0,.314-0.8,0.84,0.84,0,0,0-.238-0.619,0.8,0.8,0,0,0-.594-0.239,1.154,1.154,0,0,0-.781.3,4.607,4.607,0,0,0-.781,1q-0.091.15-.218,0.346l-0.246.38c-0.068-.288-0.137-0.582-0.212-0.885-0.459-1.847-2.494-.984-2.941-0.8-0.482.2-.353,0.647-0.094,0.529a0.869,0.869,0,0,1,1.281.585c0.217,0.751.377,1.436,0.527,2.038a5.688,5.688,0,0,1-.362.467,2.69,2.69,0,0,1-.264.271q-0.221-.08-0.471-0.147a2.029,2.029,0,0,0-.522-0.066,1.079,1.079,0,0,0-.768.3A1.058,1.058,0,0,0,9,15.131a0.82,0.82,0,0,0,.832.852,1.134,1.134,0,0,0,.787-0.3,5.11,5.11,0,0,0,.776-0.993q0.141-.219.215-0.34c0.046-.076.122-0.194,0.223-0.346a2.786,2.786,0,0,0,.918,1.726,2.582,2.582,0,0,0,2.376-.185c0.317-.181.212-0.565,0-0.494A0.807,0.807,0,0,1,14.176,15a5.159,5.159,0,0,1-.913-2.446l0,0Q13.487,12.24,13.663,12.027Z></path> </svg>";

/***/ },
/* 87 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <line class=mt-stroke x1=3 x2=3 y1=4 y2=14></line> <line class=mt-stroke x1=11 x2=11 y1=4 y2=14></line> <line class=mt-stroke x1=11 x2=3 y1=9 y2=9></line> <line class=\"mt-stroke mt-thin\" x1=13.5 x2=15.5 y1=14.5 y2=14.5></line> <path class=mt-fill d=M14.5,15a0.5,0.5,0,0,1-.5-0.5V12.085l-0.276.138A0.5,0.5,0,0,1,13.053,12c-0.124-.247-0.023-0.324.224-0.447l1-.5A0.5,0.5,0,0,1,15,11.5v3A0.5,0.5,0,0,1,14.5,15Z></path> </svg>";

/***/ },
/* 88 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <line class=mt-stroke x1=3 x2=3 y1=4 y2=14></line> <line class=mt-stroke x1=11 x2=11 y1=4 y2=14></line> <line class=mt-stroke x1=11 x2=3 y1=9 y2=9></line> <path class=\"mt-stroke mt-thin\" d=M15.5,14.5h-2c0-.234,1.85-1.076,1.85-2.234a0.959,0.959,0,0,0-1.85-.109></path> </svg>";

/***/ },
/* 89 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <line class=mt-stroke x1=7 x2=13 y1=4 y2=4></line> <line class=mt-stroke x1=5 x2=11 y1=14 y2=14></line> <line class=mt-stroke x1=8 x2=10 y1=14 y2=4></line> </svg>";

/***/ },
/* 90 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <rect class=mt-stroke height=10 width=12 x=3 y=4></rect> <circle class=mt-fill cx=6 cy=7 r=1></circle> <polyline class=\"mt-even mt-fill\" points=\"5 12 5 11 7 9 8 10 11 7 13 9 13 12 5 12\"></polyline> </svg>";

/***/ },
/* 91 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <line class=mt-stroke x1=3 x2=15 y1=14 y2=14></line> <line class=mt-stroke x1=3 x2=15 y1=4 y2=4></line> <line class=mt-stroke x1=9 x2=15 y1=9 y2=9></line> <polyline class=\"mt-fill mt-stroke\" points=\"3 7 3 11 5 9 3 7\"></polyline> </svg>";

/***/ },
/* 92 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <line class=mt-stroke x1=3 x2=15 y1=14 y2=14></line> <line class=mt-stroke x1=3 x2=15 y1=4 y2=4></line> <line class=mt-stroke x1=9 x2=15 y1=9 y2=9></line> <polyline class=mt-stroke points=\"5 7 5 11 3 9 5 7\"></polyline> </svg>";

/***/ },
/* 93 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <line class=mt-stroke x1=7 x2=11 y1=7 y2=11></line> <path class=\"mt-even mt-stroke\" d=M8.9,4.577a3.476,3.476,0,0,1,.36,4.679A3.476,3.476,0,0,1,4.577,8.9C3.185,7.5,2.035,6.4,4.217,4.217S7.5,3.185,8.9,4.577Z></path> <path class=\"mt-even mt-stroke\" d=M13.423,9.1a3.476,3.476,0,0,0-4.679-.36,3.476,3.476,0,0,0,.36,4.679c1.392,1.392,2.5,2.542,4.679.36S14.815,10.5,13.423,9.1Z></path> </svg>";

/***/ },
/* 94 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <line class=mt-stroke x1=7 x2=15 y1=4 y2=4></line> <line class=mt-stroke x1=7 x2=15 y1=9 y2=9></line> <line class=mt-stroke x1=7 x2=15 y1=14 y2=14></line> <line class=\"mt-stroke mt-thin\" x1=2.5 x2=4.5 y1=5.5 y2=5.5></line> <path class=mt-fill d=M3.5,6A0.5,0.5,0,0,1,3,5.5V3.085l-0.276.138A0.5,0.5,0,0,1,2.053,3c-0.124-.247-0.023-0.324.224-0.447l1-.5A0.5,0.5,0,0,1,4,2.5v3A0.5,0.5,0,0,1,3.5,6Z></path> <path class=\"mt-stroke mt-thin\" d=M4.5,10.5h-2c0-.234,1.85-1.076,1.85-2.234A0.959,0.959,0,0,0,2.5,8.156></path> <path class=\"mt-stroke mt-thin\" d=M2.5,14.846a0.959,0.959,0,0,0,1.85-.109A0.7,0.7,0,0,0,3.75,14a0.688,0.688,0,0,0,.6-0.736,0.959,0.959,0,0,0-1.85-.109></path> </svg>";

/***/ },
/* 95 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <line class=mt-stroke x1=6 x2=15 y1=4 y2=4></line> <line class=mt-stroke x1=6 x2=15 y1=9 y2=9></line> <line class=mt-stroke x1=6 x2=15 y1=14 y2=14></line> <line class=mt-stroke x1=3 x2=3 y1=4 y2=4></line> <line class=mt-stroke x1=3 x2=3 y1=9 y2=9></line> <line class=mt-stroke x1=3 x2=3 y1=14 y2=14></line> </svg>";

/***/ },
/* 96 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <path class=mt-fill d=M15.5,15H13.861a3.858,3.858,0,0,0,1.914-2.975,1.8,1.8,0,0,0-1.6-1.751A1.921,1.921,0,0,0,12.021,11.7a0.50013,0.50013,0,1,0,.957.291h0a0.914,0.914,0,0,1,1.053-.725,0.81,0.81,0,0,1,.744.762c0,1.076-1.16971,1.86982-1.93971,2.43082A1.45639,1.45639,0,0,0,12,15.5a0.5,0.5,0,0,0,.5.5h3A0.5,0.5,0,0,0,15.5,15Z /> <path class=mt-fill d=M9.65,5.241a1,1,0,0,0-1.409.108L6,7.964,3.759,5.349A1,1,0,0,0,2.192,6.59178Q2.21541,6.6213,2.241,6.649L4.684,9.5,2.241,12.35A1,1,0,0,0,3.71,13.70722q0.02557-.02768.049-0.05722L6,11.036,8.241,13.65a1,1,0,1,0,1.567-1.24277Q9.78459,12.3777,9.759,12.35L7.316,9.5,9.759,6.651A1,1,0,0,0,9.65,5.241Z /> </svg>";

/***/ },
/* 97 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <path class=mt-fill d=M15.5,7H13.861a4.015,4.015,0,0,0,1.914-2.975,1.8,1.8,0,0,0-1.6-1.751A1.922,1.922,0,0,0,12.021,3.7a0.5,0.5,0,1,0,.957.291,0.917,0.917,0,0,1,1.053-.725,0.81,0.81,0,0,1,.744.762c0,1.077-1.164,1.925-1.934,2.486A1.423,1.423,0,0,0,12,7.5a0.5,0.5,0,0,0,.5.5h3A0.5,0.5,0,0,0,15.5,7Z /> <path class=mt-fill d=M9.651,5.241a1,1,0,0,0-1.41.108L6,7.964,3.759,5.349a1,1,0,1,0-1.519,1.3L4.683,9.5,2.241,12.35a1,1,0,1,0,1.519,1.3L6,11.036,8.241,13.65a1,1,0,0,0,1.519-1.3L7.317,9.5,9.759,6.651A1,1,0,0,0,9.651,5.241Z /> </svg>";

/***/ },
/* 98 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <line class=\"mt-stroke mt-thin\" x1=15.5 x2=2.5 y1=8.5 y2=9.5></line> <path class=mt-fill d=M9.007,8C6.542,7.791,6,7.519,6,6.5,6,5.792,7.283,5,9,5c1.571,0,2.765.679,2.969,1.309a1,1,0,0,0,1.9-.617C13.356,4.106,11.354,3,9,3,6.2,3,4,4.538,4,6.5a3.2,3.2,0,0,0,.5,1.843Z></path> <path class=mt-fill d=M8.984,10C11.457,10.208,12,10.479,12,11.5c0,0.708-1.283,1.5-3,1.5-1.571,0-2.765-.679-2.969-1.309a1,1,0,1,0-1.9.617C4.644,13.894,6.646,15,9,15c2.8,0,5-1.538,5-3.5a3.2,3.2,0,0,0-.5-1.843Z></path> </svg>";

/***/ },
/* 99 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <path class=mt-stroke d=M5,3V9a4.012,4.012,0,0,0,4,4H9a4.012,4.012,0,0,0,4-4V3></path> <rect class=mt-fill height=1 rx=0.5 ry=0.5 width=12 x=3 y=15></rect> </svg>";

/***/ },
/* 100 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <rect class=mt-stroke height=12 width=12 x=3 y=3></rect> <rect class=mt-fill height=12 width=1 x=5 y=3></rect> <rect class=mt-fill height=12 width=1 x=12 y=3></rect> <rect class=mt-fill height=2 width=8 x=5 y=8></rect> <rect class=mt-fill height=1 width=3 x=3 y=5></rect> <rect class=mt-fill height=1 width=3 x=3 y=7></rect> <rect class=mt-fill height=1 width=3 x=3 y=10></rect> <rect class=mt-fill height=1 width=3 x=3 y=12></rect> <rect class=mt-fill height=1 width=3 x=12 y=5></rect> <rect class=mt-fill height=1 width=3 x=12 y=7></rect> <rect class=mt-fill height=1 width=3 x=12 y=10></rect> <rect class=mt-fill height=1 width=3 x=12 y=12></rect> </svg>";
	...
	var Picker = function () {
	  function Picker(select) {
	    ...
	    this.label.addEventListener('click', function (event) {
	      _this.container.classList.toggle('mt-expanded');
	    });
	  ...
	  _createClass(Picker, [{
	    ...
	    value: function buildItem(option) {
	      ...
	      item.classList.add('mt-picker-item');
	    ...
	    value: function buildLabel() {
	      ...
	      label.classList.add('mt-picker-label');
	    ...
	    value: function buildOptions() {
	      ...
	      options.classList.add('mt-picker-options');
	    ...
	    value: function buildPicker() {
	      ...
	      this.container.classList.add('mt-picker');
	    ...
	    value: function close() {
	      this.container.classList.remove('mt-expanded');
	    }
	  }, {
	    key: 'selectItem',
	    value: function selectItem(item) {
	      ...
	      var selected = this.container.querySelector('.mt-selected');
	      if (item === selected) return;
	      if (selected != null) {
	        selected.classList.remove('mt-selected');
	      }
	      if (item != null) {
	        item.classList.add('mt-selected');
	    ...
	    value: function update() {
	      ...
	      if (this.select.selectedIndex > -1) {
	        var item = this.container.querySelector('.mt-picker-options').children[this.select.selectedIndex];
	      ...
	      this.label.classList.toggle('mt-active', isActive);
	    }
	  }]);
...
/***/ function(module, exports) {
	...
	module.exports = "<svg viewbox=\"0 0 18 18\"> <polygon class=mt-stroke points=\"7 11 9 13 11 11 7 11\"></polygon> <polygon class=mt-stroke points=\"7 7 9 5 11 7 7 7\"></polygon> </svg>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ColorPicker = function (_Picker) {
	  ...
	  function ColorPicker(select, label) {
	    ...
	    _this.container.classList.add('mt-color-picker');
	    [].slice.call(_this.container.querySelectorAll('.mt-picker-item'), 0, 7).forEach(function (item) {
	      item.classList.add('mt-primary');
	    });
	    return _this;
	  }
	  ...
	  _createClass(ColorPicker, [{
	    ...
	    value: function selectItem(item, trigger) {
	      ...
	      var colorLabel = this.label.querySelector('.mt-color-label');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var IconPicker = function (_Picker) {
	  ...
	  function IconPicker(select, icons) {
	    ...
	    _this.container.classList.add('mt-icon-picker');
	    [].forEach.call(_this.container.querySelectorAll('.mt-picker-item'), function (item) {
	      item.innerHTML = icons[item.getAttribute('data-value') || ''];
	    });
	    _this.defaultItem = _this.container.querySelector('.mt-selected');
...
/***/ function(module, exports) {
	...
	var Tooltip = function () {
	  function Tooltip(quill, boundsContainer) {
	    ...
	    this.root = quill.addContainer('mt-tooltip');
	  ...
	  _createClass(Tooltip, [{
	    ...
	    value: function checkBounds() {
	      this.root.classList.toggle('mt-out-top', this.root.offsetTop <= 0);
	      this.root.classList.remove('mt-out-bottom');
	      this.root.classList.toggle('mt-out-bottom', this.root.offsetTop + this.root.offsetHeight >= this.quill.root.offsetHeight);
	    }
	  }, {
	    key: 'hide',
	    value: function hide() {
	      this.root.classList.add('mt-hidden');
	    }
	  }, {
	    key: 'position',
	    ...
	    key: 'show',
	    value: function show() {
	      this.root.classList.remove('mt-editing');
	      this.root.classList.remove('mt-hidden');
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BubbleTheme = function (_BaseTheme) {
	  ...
	  function BubbleTheme(quill, options) {
	    ...
	    _this.quill.container.classList.add('mt-bubble');
	    return _this;
	  }
	...
	var BubbleTooltip = function (_BaseTooltip) {
	  ...
	  _createClass(BubbleTooltip, [{
	    ...
	    value: function listen() {
	      ...
	      this.root.querySelector('.mt-close').addEventListener('click', function (event) {
	        _this3.root.classList.remove('mt-editing');
	      });
	      this.quill.on(_emitter2.default.events.SCROLL_OPTIMIZE, function () {
	        // Let selection be restored by toolbar handlers before repositioning
	        setTimeout(function () {
	          if (_this3.root.classList.contains('mt-hidden')) return;
	    ...
	    value: function position(reference) {
	      ...
	      var arrow = this.root.querySelector('.mt-tooltip-arrow');
	...
	BubbleTooltip.TEMPLATE = ['<span class="mt-tooltip-arrow"></span>', '<div class="mt-tooltip-editor">', '<input type="text" data-formula="e=mc^2" data-link="quilljs.com" data-video="Embed URL">', '<a class="mt-close"></a>', '</div>'].join('');
	  ...
	  _createClass(BaseTheme, [{
	    ...
	    value: function buildPickers(selects) {
	      ...
	      this.pickers = selects.map(function (select) {
	        if (select.classList.contains('mt-align')) {
	          if (select.querySelector('option') == null) {
	            fillSelect(select, ALIGNS);
	          }
	          return new _iconPicker2.default(select, _icons2.default.align);
	        } else if (select.classList.contains('mt-background') || select.classList.contains('mt-color')) {
	          var format = select.classList.contains('mt-background') ? 'background' : 'color';
	          if (select.querySelector('option') == null) {
	          ...
	          if (select.querySelector('option') == null) {
	            if (select.classList.contains('mt-font')) {
	              fillSelect(select, FONTS);
	            } else if (select.classList.contains('mt-header')) {
	              fillSelect(select, HEADERS);
	            } else if (select.classList.contains('mt-size')) {
	    ...
	    toolbar: {
	      handlers: {
	        ...
	        image: function image(value) {
	          ...
	          var fileInput = this.container.querySelector('input.mt-image[type=file]');
	          if (fileInput == null) {
	            fileInput = document.createElement('input');
	            fileInput.setAttribute('type', 'file');
	            fileInput.setAttribute('accept', 'image/*');
	            fileInput.classList.add('mt-image');
	...
	var BaseTooltip = function (_Tooltip) {
	  ...
	  _createClass(BaseTooltip, [{
	    ...
	    value: function edit() {
	      ...
	      this.root.classList.remove('mt-hidden');
	      this.root.classList.add('mt-editing');
	      if (preview != null) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SnowTheme = function (_BaseTheme) {
	  ...
	  function SnowTheme(quill, options) {
	    ...
	    _this.quill.container.classList.add('mt-snow');
	    return _this;
	  }
	  ...
	  _createClass(SnowTheme, [{
	    key: 'extendToolbar',
	    value: function extendToolbar(toolbar) {
	      toolbar.container.classList.add('mt-snow');
	      this.buildButtons([].slice.call(toolbar.container.querySelectorAll('button')));
	      this.buildPickers([].slice.call(toolbar.container.querySelectorAll('select')));
	      this.tooltip = new SnowTooltip(this.quill, this.options.bounds);
	      if (toolbar.container.querySelector('.mt-link')) {
	...
	var SnowTooltip = function (_BaseTooltip) {
	  ...
	  function SnowTooltip(quill, bounds) {
	    ...
	    _this2.preview = _this2.root.querySelector('a.mt-preview');
	    return _this2;
	  }
	  ...
	  _createClass(SnowTooltip, [{
	    ...
	    value: function listen() {
	      ...
	      this.root.querySelector('a.mt-action').addEventListener('click', function (event) {
	        if (_this3.root.classList.contains('mt-editing')) {
	          _this3.save();
	        } else {
	      ...
	      this.root.querySelector('a.mt-remove').addEventListener('click', function (event) {
	...
	SnowTooltip.TEMPLATE = ['<a class="mt-preview" target="_blank" href="about:blank"></a>', '<input type="text" data-formula="e=mc^2" data-link="quilljs.com" data-video="Embed URL">', '<a class="mt-action"></a>', '<a class="mt-remove"></a>'].join('');
